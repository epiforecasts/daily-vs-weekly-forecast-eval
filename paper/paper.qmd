...
For the rescaled weekly analysis, each epidemiological week was mapped to one step on a compressed pseudo-daily time axis. Delay and generation-time assumptions were rescaled to this axis for fitting, and forecast dates were mapped back to calendar-week dates for evaluation and visualisation.
